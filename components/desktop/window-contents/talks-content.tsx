    ...
    <div className="space-y-4 font-mono text-sm pr-4 overflow-hidden">
      ...
      <div className="flex flex-wrap gap-2">
        {PLATFORM_LINKS.map((link, index) => (
          ...
          >
            {getPlatformIconLarge(link.platform)}
      ...
      <div className="space-y-3">
        {EPISODES.map((episode, index) => (
          <div
            key={index}
            className="border-2 border-[#2a2a2a] bg-[#f5f5f0] p-3"
          >
            ...
            <div className="flex gap-2 mt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center justify-center w-7 h-7 text-white rounded transition-colors ${getPlatformColor("youtube")}`}
                title="YouTube"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center justify-center w-7 h-7 text-white rounded transition-colors ${getPlatformColor("apple")}`}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center justify-center w-7 h-7 text-white rounded transition-colors ${getPlatformColor("spotify")}`}
                title="Spotify"
              >
