...
export function SupportContent() {
  return (
    <div className="p-4 space-y-4 bg-[#f5f0e6]">
      {/* Warm header */}
      <div className="text-center space-y-2">
        <div className="flex justify-center">
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#f5d442] via-[#e6c030] to-[#c9a227] border-2 border-[#8B6914] flex items-center justify-center shadow-md">
            <svg width="20" height="18" viewBox="0 0 16 14" fill="#8B6914">
        ...
        <h2 className="text-lg font-semibold text-[#2a2a2a]">Support My Work</h2>
        <p className="text-sm text-[#5a5a5a] leading-relaxed">
          If you enjoy my podcast or writing, consider buying me a coffee. Your support helps keep the conversations going.
        </p>
      </div>
      ...
      {/* Thank you note */}
      <p className="text-xs text-center text-[#8a8a7a] pt-2">
