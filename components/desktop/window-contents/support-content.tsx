...
export function SupportContent() {
  return (
<div className="p-3 space-y-2 bg-[#f5f0e6]">
      {/* Warm header */}
      <div className="text-center space-y-1">
        <div className="flex justify-center">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#f5d442] via-[#e6c030] to-[#c9a227] border-2 border-[#8B6914] flex items-center justify-center shadow-md">
            <svg width="14" height="12" viewBox="0 0 16 14" fill="#8B6914">
